const { z } = require("zod"); // Import zod library for schema validation

const signupSchema = z.object({ // Define schema for signup validation
  deskName: z // deskName field validation
    ...
    password: z // password field validation
